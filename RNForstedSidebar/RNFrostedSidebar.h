...
@property (nonatomic, assign) BOOL showFromTop;
...
@property (nonatomic, strong) UIColor *siderBackgroundColor;

@property (nonatomic, strong) UIColor *majorBackgroundColor;

@property (nonatomic, assign) CGFloat backgroundColorAlpha;

@property (nonatomic, assign) CGFloat majorBackgroundColorAlpha;

@property (nonatomic, assign) BOOL majorViewAnimation;
...
- (instancetype)initWithCustomViews:(NSArray *)customViews selectedIndices:(NSIndexSet *)selectedIndices borderColors:(NSArray *)colors  alwaysVertical:(BOOL) alwaysVertical;
- (instancetype)initWithCustomViews:(NSArray *)customViews selectedIndices:(NSIndexSet *)selectedIndices;
